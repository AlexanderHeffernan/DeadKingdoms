...
export class UI {
	...
	constructor(state: GameState, actions: UIActions, actionHotkeys: ActionHotkeys) {
		...
		const adminDashboard = new AdminDashboard({
			...
			bansTab: mustGet("adminBansTab") as HTMLButtonElement,
			...
			bansView: mustGet("adminBansView"),
			...
			pauseButton: mustGet("adminPerfPauseButton") as HTMLButtonElement,
			playerTableBody: mustGet("adminPlayerTableBody") as HTMLTableSectionElement,
			banTableBody: mustGet("adminBanTableBody") as HTMLTableSectionElement,
			...
			enablePathDebugButton: mustGet("adminEnablePathDebugButton") as HTMLButtonElement,
			enablePathAvailabilityButton: mustGet("adminEnablePathAvailabilityButton") as HTMLButtonElement,
			enableUnitTileButton: mustGet("adminEnableUnitTileButton") as HTMLButtonElement,
			...
			grantWoodButton: mustGet("adminGrantWoodButton") as HTMLButtonElement,
			grantFoodButton: mustGet("adminGrantFoodButton") as HTMLButtonElement,
			grantStoneButton: mustGet("adminGrantStoneButton") as HTMLButtonElement,
			...
			togglePathDebug: actions.togglePathDebug,
			togglePathAvailabilityDebug: actions.togglePathAvailabilityDebug,
			toggleUnitTileDebug: actions.toggleUnitTileDebug,
			kickPlayer: actions.kickPlayer,
			banPlayer: actions.banPlayer,
			unbanIp: actions.unbanIp,
			spawnHostileHorde: actions.spawnHostileHorde,
			grantSoldiers: actions.grantSoldiers,
			grantResources: actions.grantResources,
